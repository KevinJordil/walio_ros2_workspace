...
#define HAL_IOCTL_GETP			_IOW(0x05000000, 12, char)
#define HAL_IOCTL_SETS          _IOW(0x05000000, 13, char)
#define HAL_IOCTL_GETS          _IOW(0x05000000, 14, char)
